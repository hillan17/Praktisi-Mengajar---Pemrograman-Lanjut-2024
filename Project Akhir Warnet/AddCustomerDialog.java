...
public class AddCustomerDialog extends JDialog {
    ...
    private JTextField laptopNumberField;
    ...
    public AddCustomerDialog(MainFrame mainFrame) {
        ...
        JLabel laptopNumberLabel = new JLabel("Laptop Number:");
        JLabel computerLabel = new JLabel("Computer:");

        nameField = new JTextField(20);
        ageField = new JTextField(20);
        laptopNumberField = new JTextField(20);
    ...
    private void addCustomer() {
        ...
        String laptopNumber = laptopNumberField.getText().trim();
        String computer = (String) computerComboBox.getSelectedItem();

        if (name.isEmpty() || ageText.isEmpty() || laptopNumber.isEmpty()) {
        ...
        try {
            ...
            Customer customer = new Customer(name, age, laptopNumber);
